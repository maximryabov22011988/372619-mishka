...
/*! Plugin picturefill - intrinsic dimension
   The 2x source will be automatically scaled down by 2 — so that the image will occupy the same space in your layout as the 1x, but the 2x source will be displayed at double the pixel density. This only applies to the natural size of the img—resizing the image via CSS or with the width content attribute will behave as expected.
 * https://scottjehl.github.io/picturefill/
 * Copyright (c) 2016 https://github.com/scottjehl/picturefill/blob/master/Authors.txt; Licensed MIT
 */
(function( factory ) {
